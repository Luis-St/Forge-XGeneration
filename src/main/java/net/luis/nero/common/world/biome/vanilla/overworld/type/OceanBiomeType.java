...
public enum OceanBiomeType implements IBiomeType {
  ...
  /*LEGACY_FORZEN_OCEAN(0.0F, 0.0, 0.0, null, null, null)*/; // TODO: add surfaceBuilder & features
	...
	private OceanBiomeType(float temperature, double baseNoise, double noiseScale, INoiseType noiseType, MobSpawnBuilder mobBuilder, BiomeGenerationBuilder generationBuilder) {
		this(temperature, baseNoise, noiseScale, noiseType, mobBuilder.build(), generationBuilder.build());
	}
	
	private OceanBiomeType(float temperature, double baseNoise, double noiseScale, INoiseType noiseType, MobSpawnSettings mobSettings, BiomeGenerationSettings generationSettings) {
