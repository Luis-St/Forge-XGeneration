...
public enum MushroomFieldsBiomeType implements IBiomeType {
	...
	MUSHROOM_FIELDS(BiomeNoise.of(0.2, 0.3), BiomeSettings.getMushroomFieldsSpawns(false), false),
	MUSHROOM_FIELD_SHORE(BiomeNoise.of(0.0, 0.025), BiomeSettings.getMushroomFieldsSpawns(true), true);
