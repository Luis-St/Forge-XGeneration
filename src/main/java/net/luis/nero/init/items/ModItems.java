...
public class ModItems {
	...
	public static final RegistryObject<Item> COPPER_INGOT = ITEMS.register("copper_ingot", 
			() -> new Item(new Item.Properties().tab(Nero.MISC)));
	...
	public static final RegistryObject<Item> VOID_RUNE = ITEMS.register("void_rune",
			() -> new Item(new Item.Properties().tab(Nero.BLOOD_MACIC).stacksTo(1))); // TODO: rune item and effect
	public static final RegistryObject<Item> AIR_RUNE = ITEMS.register("air_rune", // -> getViewVector(1) motion in view direction
			() -> new Item(new Item.Properties().tab(Nero.BLOOD_MACIC).stacksTo(1))); // TODO: rune item and effect
