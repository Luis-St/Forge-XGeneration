...
public class ModStructures {
	...
	public static final RegistryObject<DeepslateMineshaftStructure> DEEPSLATE_MINESHAFT = STRUCTURES.register("deepslate_mineshaft", DeepslateMineshaftStructure::new);
