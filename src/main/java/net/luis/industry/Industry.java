...
import net.luis.industry.init.world.biome.ModBiomes;
...
//			Industry.LOGGER.debug("Biome: " + biome.getRegistryName());
//			Industry.LOGGER.debug("Biome Key: " + ForgeRegistries.BIOMES.getKey(biome));
//		}
//		try {
