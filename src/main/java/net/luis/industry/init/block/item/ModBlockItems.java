...
public class ModBlockItems {
	...
	public static final RegistryObject<Item> DEEPSLATE_COAL_ORE = ITEMS.register("deepslate_coal_ore", 
			() -> new BlockItem(ModBlocks.DEEPSLATE_COAL_ORE.get(), new Item.Properties().tab(BUILDING_BLOCKS)));
	
	public static final RegistryObject<Item> DEEPSLATE_IRON_ORE = ITEMS.register("deepslate_iron_ore", 
			() -> new BlockItem(ModBlocks.DEEPSLATE_IRON_ORE.get(), new Item.Properties().tab(BUILDING_BLOCKS)));
	
	public static final RegistryObject<Item> DEEPSLATE_COPPER_ORE = ITEMS.register("deepslate_copper_ore", 
			() -> new BlockItem(ModBlocks.DEEPSLATE_COPPER_ORE.get(), new Item.Properties().tab(BUILDING_BLOCKS)));
	
	public static final RegistryObject<Item> DEEPSLATE_GOLD_ORE = ITEMS.register("deepslate_gold_ore", 
			() -> new BlockItem(ModBlocks.DEEPSLATE_GOLD_ORE.get(), new Item.Properties().tab(BUILDING_BLOCKS)));
	
	public static final RegistryObject<Item> DEEPSLATE_LAPIS_ORE = ITEMS.register("deepslate_lapis_ore", 
			() -> new BlockItem(ModBlocks.DEEPSLATE_LAPIS_ORE.get(), new Item.Properties().tab(BUILDING_BLOCKS)));
	
	public static final RegistryObject<Item> DEEPSLATE_REDSTONE_ORE = ITEMS.register("deepslate_redstone_ore", 
			() -> new BlockItem(ModBlocks.DEEPSLATE_REDSTONE_ORE.get(), new Item.Properties().tab(BUILDING_BLOCKS)));
	
	public static final RegistryObject<Item> DEEPSLATE_DIAMOND_ORE = ITEMS.register("deepslate_diamond_ore", 
			() -> new BlockItem(ModBlocks.DEEPSLATE_DIAMOND_ORE.get(), new Item.Properties().tab(BUILDING_BLOCKS)));
	
	public static final RegistryObject<Item> DEEPSLATE_EMERALD_ORE = ITEMS.register("deepslate_emerald_ore", 
